...
if [ $cont -eq 101 ]; then
	...
	pct start 101
	pct push 101 /root/aceshoneypot/financials.txt ~/financials.txt
...
# create container 102: has 2GB RAM
	...
	pct start 102
	pct push 102 /root/aceshoneypot/financials.txt ~/financials.txt
...
# create container 201: has 6GB RAM
	...
	pct start 201
	pct push 201 /root/aceshoneypot/financials.txt ~/financials.txt
...
# create container 202: has 6GB RAM
	...
	pct start 202
	pct push 202 /root/aceshoneypot/financials.txt ~/financials.txt
